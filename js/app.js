...
$(document).ready(function () {
    ...
    $.getJSON('http://localhost:8080/proyectoV1/api/categorias', function (categorias) { //lamada Json para rellenar categorias
        ...
        htmlCode += '';
        htmlCode += '<a href="carrito.html" id="verCarrito" style="width:50%" class="btn btn-primary btn-lg " type="button" aria-pressed="true">Carrito</a>';
        htmlCode += '<a href="admin.html" class="btn btn-secondary btn-lg" style="width:50%" type="button" aria-pressed="true">Admin</a>';
